# -*- coding: utf-8 -*-
"""
EDA (8주 + 시청률) — 드라마 촬영지 관광 효과 분석
데이터: preprocessing/Final_dataset_8w_rating_v2.csv
        (기존 preprocessing 데이터에 시청률 데이터 추가, 전후 8주 기준)
...
df = pd.read_csv('../preprocessing/Final_dataset_8w_rating_v2.csv')
